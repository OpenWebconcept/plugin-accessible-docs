...
use OWCAD\Vendor_Prefixed\DI\Definition\FactoryDefinition;
...
use OWCAD\Vendor_Prefixed\DI\Definition\Resolver\ResolverDispatcher;
use OWCAD\Vendor_Prefixed\DI\Definition\Source\DefinitionArray;
use OWCAD\Vendor_Prefixed\DI\Definition\Source\MutableDefinitionSource;
use OWCAD\Vendor_Prefixed\DI\Definition\Source\ReflectionBasedAutowiring;
use OWCAD\Vendor_Prefixed\DI\Definition\Source\SourceChain;
use OWCAD\Vendor_Prefixed\DI\Definition\ValueDefinition;
use OWCAD\Vendor_Prefixed\DI\Invoker\DefinitionParameterResolver;
use OWCAD\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use OWCAD\Vendor_Prefixed\Invoker\Invoker;
use OWCAD\Vendor_Prefixed\Invoker\InvokerInterface;
use OWCAD\Vendor_Prefixed\Invoker\ParameterResolver\AssociativeArrayResolver;
use OWCAD\Vendor_Prefixed\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use OWCAD\Vendor_Prefixed\Invoker\ParameterResolver\DefaultValueResolver;
use OWCAD\Vendor_Prefixed\Invoker\ParameterResolver\NumericArrayResolver;
use OWCAD\Vendor_Prefixed\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \OWCAD\Vendor_Prefixed\DI\get().
     *
