...
use function chmod;
use OWCAD\Vendor_Prefixed\DI\Definition\ArrayDefinition;
use OWCAD\Vendor_Prefixed\DI\Definition\DecoratorDefinition;
...
use OWCAD\Vendor_Prefixed\DI\Definition\Source\DefinitionSource;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \OWCAD\Vendor_Prefixed\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
            case $definition instanceof EnvironmentVariableDefinition:
                ...
                $code = <<<PHP
                            ...
                            if (!$isOptional) {
                                throw new \OWCAD\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
                            }
                            return $defaultValue;
                    PHP;
                break;
